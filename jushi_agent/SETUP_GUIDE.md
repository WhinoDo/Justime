...
# MongoDB 数据库配置
MONGODB_URI=mongodb://localhost:27017/jushi_agent
...
4. 更新 `.env.local` 中的 `MONGODB_URI`：
   ```env
   MONGODB_URI=mongodb+srv://<username>:<password>@cluster0.xxxxx.mongodb.net/jushi_agent?retryWrites=true&w=majority
   ```
