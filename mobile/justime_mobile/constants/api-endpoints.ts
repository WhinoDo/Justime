export const API_ENDPOINTS = {
  ...
  BOOK_ANALYSIS: {
    PROJECTS: '/api/v1/book-analysis/projects',
    PROJECT: (projectId: string) => `/api/v1/book-analysis/projects/${projectId}`,
    PROJECT_CHAPTERS: (projectId: string) => `/api/v1/book-analysis/projects/${projectId}/chapters`,
    PROJECT_RUN: (projectId: string) => `/api/v1/book-analysis/projects/${projectId}/run`,
    PROJECT_STATUS: (projectId: string) => `/api/v1/book-analysis/projects/${projectId}/status`,
  },
} as const
