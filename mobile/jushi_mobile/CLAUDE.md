# Jushi Mobile Client - CLAUDE.md

This file defines the commands, architecture, and coding standards for the Expo React Native mobile client (`mobile/jushi_mobile/`).

---

## 🛠️ Build and Development Commands

Run these commands inside the `mobile/jushi_mobile/` directory:
