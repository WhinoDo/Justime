# Justime Web Frontend - CLAUDE.md

This file defines the commands, architecture, and coding standards for the Next.js web frontend (`justime_agent/`).

---

## 🛠️ Build and Development Commands

Run these commands inside the `justime_agent/` directory:
