# Justime Backend - CLAUDE.md

This file defines the commands, architecture, and coding standards for the FastAPI backend (`justime_backend/`).

---

## 🛠️ Build and Development Commands

Run these commands inside the `justime_backend/` directory:
...
- **Run SSE Diagnostic Probe Tests** (from the repository root): `pytest scripts/diagnostics/tests/test_justime_sse_probe.py -v --tb=short`
