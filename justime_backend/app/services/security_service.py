...
class SecurityService:
    ...
    def create_access_token(data: Dict[str, Any], expires_delta: Optional[timedelta] = None) -> str:
        ...
        to_encode.update({"exp": expire, "type": SecurityService.ACCESS_TOKEN_TYPE, "iss": "justime-app", "aud": "justime-users"})
    ...
    def create_refresh_token(data: Dict[str, Any], expires_delta: Optional[timedelta] = None) -> str:
        ...
        to_encode.update({"exp": expire, "type": SecurityService.REFRESH_TOKEN_TYPE, "iss": "justime-app", "aud": "justime-users"})
    ...
    def decode_access_token(token: str) -> Optional[Dict[str, Any]]:
        """解码并验证访问令牌"""
        try:
            payload = jwt.decode(token, settings.JWT_SECRET, algorithms=[settings.JWT_ALGORITHM], audience="justime-users", issuer="justime-app")
    ...
    def decode_refresh_token(token: str) -> Optional[Dict[str, Any]]:
        """解码并验证刷新令牌"""
        try:
            payload = jwt.decode(token, settings.JWT_REFRESH_SECRET, algorithms=[settings.JWT_ALGORITHM], audience="justime-users", issuer="justime-app")
    ...
    def create_password_reset_token(data: Dict[str, Any], expires_delta: Optional[timedelta] = None) -> str:
        ...
        to_encode.update({"exp": expire, "type": SecurityService.PASSWORD_RESET_TOKEN_TYPE, "iss": "justime-app", "aud": "justime-users"})
    ...
    def decode_password_reset_token(token: str) -> Optional[Dict[str, Any]]:
        """解码并验证密码重置令牌"""
        try:
            payload = jwt.decode(token, settings.JWT_PASSWORD_RESET_SECRET, algorithms=[settings.JWT_ALGORITHM], audience="justime-users", issuer="justime-app")
